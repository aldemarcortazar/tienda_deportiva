...
switch($_SERVER['REQUEST_METHOD']){
    ...
    case 'POST':
        ...
        $prenda = new Prenda(null , $_POST['almacen'] , $_POST['tipo_prenda'] , $_POST['categoria'] , $_POST['talla'] , $_POST['tip_ropa'] , $_POST['nom_prenda'] , $_POST['color'] , $_POST['precio'] , $_POST['fecha_crea']);
        $res;
        if($prenda->addPrenda()){
            // Funciono el agregar
            $res = array(
